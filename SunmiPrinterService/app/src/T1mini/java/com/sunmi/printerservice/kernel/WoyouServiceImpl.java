...
public class WoyouServiceImpl extends IWoyouService.Stub implements RequestInterface {
    ...
    public WoyouServiceImpl(Context service, Handler mHandler) {
        ...
        p = new PrinterManager(service, mHandler, this);
    }
    ...
    @Override
    public synchronized void sendLCDCommand(int flag) throws RemoteException {
        ...
        data[1] = 0x1C;
        data[2] = (byte) flag;
        p.sendDataCell(new DataCell(data, DataCell.LCD_DATA));
    }

    @Override
    public synchronized void sendLCDString(String string, ILcdCallback callback) throws RemoteException {
        BitmapCreator temp = getCreator();
        temp.printLcdText(string, callback);
    }

    @Override
    public synchronized void sendLCDBitmap(Bitmap bitmap, ILcdCallback callback) throws RemoteException {
        BitmapCreator temp = getCreator();
        temp.printLcdBitmap(bitmap, callback);
    }
    ...
    @Override
    public synchronized void sendLCDDoubleString(String topText, String bottomText, ILcdCallback callback) throws RemoteException {
        BitmapCreator temp = getCreator();
        temp.printLcdText(topText, bottomText, callback);
    }
    ...
    public void netChanged(boolean onlyone){
        LogUtils.e("网络变化后是否只更新一次：" + onlyone);
    }
    ...
    public void handleSettingMessage(String msg) {
        LogUtils.e("it shouldn't have receive setting"+msg);
    }
    ...
    public void handlePushMessage(String msg) {
        LogUtils.e("it shouldn't have receive push" + msg);
    }
