/** 
 * @Title:  MyQrEncoder.java 
 * @author:  郭晗
 * @data:  2016年12月21日 下午4:33:41 <创建时间>
 * 
 * @history：<以下是历史记录>
 *
 * @modifier: <修改人>
 * @modify date: 2016年12月21日 下午4:33:41 <修改时间>
 * @log: <修改内容>
 *
 * @modifier: <修改人>
 * @modify date: 2016年12月21日 下午4:33:41 <修改时间>
...
public class MyQrEncoder {
	...
	public static QRCode encode(byte content[], ErrorCorrectionLevel ecLevel, Map<EncodeHintType, ?> hints)
	 ...
	 * the result in "bits".
	 */
	static void appendBytes(byte [] content, Mode mode, BitArray bits) throws WriterException {
	...
	static void append8BitBytes(byte [] content, BitArray bits) throws WriterException {
		for (byte b : content) {
			bits.appendBits(b, 8);
		}
	}
