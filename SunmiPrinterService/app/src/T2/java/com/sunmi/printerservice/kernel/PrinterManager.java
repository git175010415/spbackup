...
public class PrinterManager implements DownloadInterface, RawPrintInterface {
    final private PrinterState printerState;
    ...
    final private Object memoryBlock = new Object();
    final private PriorityQueue<DataCell> dataList = new PriorityQueue<>(100, new Comparator<DataCell>() {
